...
int terminate = 0;
// babblespace *my_babblespace;
babblespace **babb_ptr;
...
void sig_handle_2()
{
  pthread_mutex_lock(&(*babb_ptr)->babble_mutex);
  ...
  print_babbles(*babb_ptr);

  // printf("\033[u");
  printf("\033[35;1H");

  pthread_mutex_unlock(&(*babb_ptr)->babble_mutex);
